  ...
  <div class="app-container">
    ...
    <el-dialog :visible.sync="editFormVisible" title="新增车商" width="33%">
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="100px">
        <el-form-item label="车商名称" prop="dealerName">
          <el-input v-model="editForm.dealerName" autocomplete="off" placeholder="请输入车商名称"/>
        </el-form-item>
        <el-form-item label="所属分公司" prop="carDealerOrgId">
        ...
        <el-form-item label="省份" prop="provinceId">
          <el-select v-model="editForm.provinceId" placeholder="请选择省份" @change="provinceChange">
            <el-option
              v-for="item in provinceData"
              :key="item.areaId"
              :label="item.areaName"
        ...
        <el-form-item label="城市" prop="cityId">
          <el-select v-model="editForm.cityId" placeholder="请选择城市" @change="cityChange">
            <el-option
              v-for="item in cityData"
              :key="item.areaId"
              :label="item.areaName"
